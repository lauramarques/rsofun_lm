...
Fluxnet <- read.csv("~/GFDY/data/raw_mod/FLX_CH-Lae_FLUXNET2015_FULLSET_YY_2004-2014_1-3.csv")
...
## Target 2. LAI ####
lai_LAE <- read.csv("~/GFDY/data/raw_mod/MODIS_LAI_MCD15A3H_daily_CH-Lae.csv")
...
LAE_data <- read.csv("~/GFDY/data/raw_mod/20201216_Laegeren_data.csv")
