...
# Dimensions: time
# tile output
figAGB <- BiomeE_P0_BIA_eCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_P0_BIA_eCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS1_BIA_aCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS1_BIA_aCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS2_BIA_aCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS2_BIA_aCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS3_BIA_aCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS3_BIA_aCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS4_BIA_aCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS4_BIA_aCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS5_BIA_aCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS5_BIA_aCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS6_BIA_aCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS6_BIA_aCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS1_BIA_eCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS1_BIA_eCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS2_BIA_eCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS2_BIA_eCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS3_BIA_eCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS3_BIA_eCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS4_BIA_eCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS4_BIA_eCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS5_BIA_eCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS5_BIA_eCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
...
# Dimensions: time
# tile output
figAGB <- BiomeE_PS6_BIA_eCO2_annual_tile %>%
  slice(510+1:nrow(BiomeE_PS6_BIA_eCO2_annual_tile)) %>% 
  mutate(year = 1:450, AGB = NSC+leafC+(SapwoodC+WoodC)*0.75) %>%
  select(year, AGB)  %>%
  ggplot() + 
