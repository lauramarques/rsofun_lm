...
PFT_species <- c("Picea_abies","Betula_pendula","Tilia_cordata","Grasses") 
PFT_reorder <- c(1,2,3,4)
PFT <- c(4,3,2,1)
PFT_BIA <- tibble(PFT_species,PFT_reorder,PFT)
...
# Dimensions: time
# tile output
AGB <- BiomeE_P0_BIA_aCO2_annual_tile %>%
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_cwood_size_P0_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_nstem_size_P0_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_WBgrowth_P0_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
pft <- as.array(seq(1,4,1))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_BAgrowth_P0_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
pft <- as.array(seq(1,4,1))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_stemmort_P0_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# Dimensions: time
# tile output
AGB <- BiomeE_PS1_BIA_aCO2_annual_tile %>%
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_cwood_size_PS1_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_nstem_size_PS1_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_WBgrowth_PS1_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
pft <- as.array(seq(1,4,1))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_BAgrowth_PS1_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
pft <- as.array(seq(1,4,1))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_stemmort_PS1_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# Dimensions: time
# tile output
AGB <- BiomeE_PS2_BIA_aCO2_annual_tile %>%
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_cwood_size_PS2_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_nstem_size_PS2_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_WBgrowth_PS2_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
pft <- as.array(seq(1,4,1))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_BAgrowth_PS2_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
pft <- as.array(seq(1,4,1))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_stemmort_PS2_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# Dimensions: time
# tile output
AGB <- BiomeE_PS3_BIA_aCO2_annual_tile %>%
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_cwood_size_PS3_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_nstem_size_PS3_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_WBgrowth_PS3_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
pft <- as.array(seq(1,4,1))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_BAgrowth_PS3_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
pft <- as.array(seq(1,4,1))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# create the netCDF filename 
ncfname <- paste("~/rsofun/data/outputs_mod/nc_files/412ppm/BIA/", 
                 "BiomeEP_stemmort_PS3_BIA", ".nc", sep="")
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90))
time_dim <- ncdim_def("time","years",as.double(time)) 
...
# Dimensions: time
# tile output
AGB <- BiomeE_P0_BIA_eCO2_annual_tile %>%
...
# define dimensions
time <- as.array(seq(1,450,1))
sizeclass <- as.array(c(1, 5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90, 100))
time_dim <- ncdim_def("time","years",as.double(time)) 
sizeclass_dim <- ncdim_def("sizeclass","cm",as.double(sizeclass)) 
# define variables
cwood_size_var <- ncvar_def("cwood_size","kg C m-2",list(time_dim,sizeclass_dim),-999,
...
# Dimensions: time
# tile output
AGB <- BiomeE_PS1_BIA_eCO2_annual_tile %>%
...
# Dimensions: time
# tile output
AGB <- BiomeE_PS2_BIA_eCO2_annual_tile %>%
...
# Dimensions: time
# tile output
AGB <- BiomeE_PS3_BIA_eCO2_annual_tile %>%
...
BAgrowth <- BiomeE_PS3_BIA_eCO2_annual_cohorts %>% 
  ...
  filter(year>510) %>%
  mutate(year = year-510) %>% left_join(PFT_BIA) %>% ungroup() %>%
  mutate(BAgrowth=ifelse(BAgrowth=="Inf",NA,BAgrowth))
BAgrowth_wid <- BAgrowth %>% select(c(year,BAgrowth,PFT_reorder)) %>% rename(PFT=PFT_reorder) %>%
  pivot_wider(names_from = PFT, values_from = BAgrowth,values_fill = 0) %>% arrange(year) %>%
  relocate(`1`,.after =year) %>% relocate(`2`,.after =`1`) %>% relocate(`3`,.after =`2`) %>%
  select(-year)
