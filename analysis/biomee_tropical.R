...
# Lon -79.75°, Lat 9.25° Tropical; Barro Colorado Island (BCI):
...
params_species <- tibble(
  ...
  pt            = c(1,0,0,0,rep(0,12)),            # 0 for C3; 1 for C4
  # Root parameters
  ...
  LMA           = c(0.025,0.03,0.07,0.07,rep(0.1,12)),  # Leaf mass per unit area. For sps: Beech-Spruce-Fir # In Ensheng rep(0.035,16)
  rho_wood      = c(90,250,360,360,rep(300,12)),         # In Ensheng rep(300,16),
  alphaBM       = rep(5200,16),                  
  thetaBM       = rep(2.5,16), 
