module md_vegetation_biomee
  ...
  ! public subroutines
  public :: initialize_cohort_from_biomass, initialize_vegn_tile!, reinitialize_vegn_tile
  ...
  public :: vegn_annual_starvation, Zero_diagnostics, disturb, reset_vegn_initial
