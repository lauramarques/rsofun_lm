...
contains
  ...
  subroutine biomee_f(            &
    ...
    ! naked arrays
    real(kind=c_double), dimension(0:MSPECIES,41), intent(in)       :: params_species
    ...
    myinterface%params_species(:)%v_seed        = real( params_species(:,33))
    myinterface%params_species(:)%fNSNmax       = real( params_species(:,34))
    myinterface%params_species(:)%LMA           = real( params_species(:,35)) ! prescribed
    myinterface%params_species(:)%rho_wood      = real( params_species(:,36)) ! prescribed
    myinterface%params_species(:)%alphaBM       = real( params_species(:,37)) ! prescribed
    myinterface%params_species(:)%thetaBM       = real( params_species(:,38)) ! prescribed
    myinterface%params_species(:)%kphio         = real( params_species(:,39)) ! calibratable
    myinterface%params_species(:)%phiRL         = real( params_species(:,40)) ! calibratable
    myinterface%params_species(:)%LAI_light     = real( params_species(:,41)) ! calibratable
